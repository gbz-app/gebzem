...
class _YorumSatiriState extends State<YorumSatiri> {
  ...
  Widget _baslik(YorumGorunum y, Color soluk, ThemeData tema) => Row(
    children: [
      ...
      // ⚠️⚠️⚠️ TURU 180t — **"GONDERI SAHIBI BEGENDI" ROZETI TAMAMEN
      //	KALDIRILDI** (kullanici emri: *"bu gonderi sahibi begeni olayini
      //	da kaldir"*).
      //
      //	Turu 180s'te rozetin ikinci parcasi (sahip avatari) kalkmis,
      //	kalp birakilmisti; kullanici tamaminin gitmesini istedi.
      // ⚠️ `Spacer` de KALKTI: tek gorevi rozeti saga itmekti. Baslik
      //	satiri artik SOLA dayali (ad · tik · zaman · rozet).
      // ⚠️ `YorumGorunum.sahipBegendi` alani ve `demo_yorum.dart`taki
      //	degerleri SILINMEDI: model alani kaldirmak dort cagri yerini
      //	birden dokundururdu ve karar geri alinabilsin.
    ],
  );
