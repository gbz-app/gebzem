...
class MedyaVideo extends ConsumerStatefulWidget {
  ...
  ///
  /// ⚠️ TURU 83 — AKISTA **false** (kullanici emri: *"alttaki ilerleme cubugu
  ///    da olmasin"*). Reels, hikaye ve tam ekranda TRUE kalir: oralarda
  ///    videonun ne kadar kaldigini gormek ISLEVSEL.
  /// ⚠️ YAPMA: varsayilani false yapma — uc yuzey birden sessizce kaybeder.
