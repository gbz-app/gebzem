...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — HİZMETTE ALT ALANLAR, YAKINIMDA SADELEŞTİ, İLAN SAHİBİ KARTI</b><br><br><b>1 · HİZMETTE ANA KARTLARIN ALTINA ALT ALANLAR GELDİ.</b> Yemekte kutuların altında &quot;Mutfaklar&quot; şeridi var; hizmette yoktu. Artık <b>Tadilat · Nakliyat · Temizlik · Tesisat · Elektrik</b> şeridi de var. <b>&quot;Taleplerim&quot; kaldırıldı</b> ve sağ üste <b>favori kalbi</b> geldi — Yemekle birebir.<br><br><b>2 · YAKINIMDA SADELEŞTİ.</b> &quot;Tümü · Yemek …&quot; ve &quot;2 km · 4+ puan&quot; çipleri artık <b>arama kutusunun üstünde</b>, arada nefes payıyla. Alttaki kategori ızgarası ve &quot;Yakınımdakiler&quot; listesi <b>kaldırıldı</b> — ekranın işi harita. Geri ve konum düğmelerinin arkasındaki daire <b>siyah hafif saydam ve gölgesiz</b>. Konum noktası artık <b>mavi değil mor</b>.<br><br><b>3 · HIZLI ERİŞİM ARTIK HARİTAYA GİDİYOR.</b> GebzemAI ve Sosyal hariç bütün kartlar (Nöbetçi Eczane · Taksi · Akaryakıt · Durak · Kuaför · Güzellik · Oto Servis) doğrudan <b>Yakınımda haritasını</b> açıyor. Bu kartların ortak yanı acil ihtiyaç olmaları: soru &quot;hangileri var&quot; değil <b>&quot;en yakını nerede&quot;</b>.<br><br><b>4 · İLAN SAHİBİ ARTIK KART.</b> İlan detayında satıcı düz bir satırdı; şimdi <b>sahibinden gibi ayrı bir profil kartı</b>: avatar, ad, onaylı rozeti, İşletme/İlan sahibi etiketi.<br><br><b>Ölçülen hata:</b> Hizmetteki yeni şeridin <b>kutuları hiç çizilmiyordu</b> — sadece yazılar görünüyordu. Sebep: çocuğu olmayan bir kutu, genişlik kısıtı gevşek olduğunda sıfır genişlik alıyor. Emülatörde görülüp düzeltildi.<br><br><b>Önceki turda:</b> bütün kategoriler Yemeğin birebir aynı sırasına geçmişti (arama → slider → kutular → şerit → filtreler → liste); Hizmetten &quot;Hangi hizmeti almak istiyorsun?&quot; ve &quot;NASIL ÇALIŞIR&quot; kaldırılmış, Etkinliklerde kategoriler kutuya çevrilmişti.<br><br><b>Dürüst sınırlar:</b> Google&#39;ın mavi konum noktası platform tarafından çiziliyor ve rengi değiştirilemiyor — o yüzden kapatılıp kendi mor işaretimiz kondu. Hızlı erişim kartlarının içeriği (&quot;Gece Kuşu&quot;, &quot;Yeni Restourant&quot;) hâlâ yemeğe özel; <b>sıradaki iş bu</b>.<br><br><b>Not:</b> <b>Yalnızca arayüz</b>, <b>yalnızca iPhone</b>. Sunucu değişmedi, hesaplar duruyor.</div>`
...
const kontroller = [
  ...
  [cikti.includes('HİZMETTE ALT ALANLAR') &&
      cikti.includes('YAKINIMDA SADELEŞTİ'),
    'turu 124 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
