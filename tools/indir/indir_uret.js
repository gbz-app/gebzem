...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde:</b><br><br><b>1 · DÜĞÜN &amp; HİZMET TEKLİF İSTEĞİ:</b> Menüden <b>Düğün &amp; Organizasyon</b>&#39;a gir, <b>adım adım</b> sorulara cevap ver (tarih, kişi sayısı, kapalı salon mu dış mekân mı, hangi hizmetler, bütçe). Talebin <b>ilgili işletmelere</b> bildirim olarak gider; onlar sana <b>fiyatlı karşı teklif</b> verir. Teklifleri <b>ucuzdan pahalıya sıralı</b> görürsün, birini <b>seçersin</b> ve talep kapanır.<br><br><b>2 · DİYET TAKİBİ:</b> <b>Diyetim</b> ekranında gün gün <b>öğün</b> ekle (yiyecek ara, gramı kaydır, kalori anında hesaplansın), <b>ölçüm</b> gir (kilo/bel/boy). Bir <b>diyetisyenle bağlantı</b> kurduğunda sana <b>haftalık diyet listesi</b> gönderebilir. Diyetisyensen <b>Danışanlarım</b>&#39;dan istekleri onaylar, liste yazar ve danışanının günlük kalorisini görürsün.<br><br><b>3 · KATEGORİLER IZGARAYA DÖNDÜ:</b> Kartlar artık <b>soldan sağa</b> akıyor, küçük ve derli toplu. <b>Yakınımda</b> hâlâ en üstte ayrı.<br><br><b>4 · HAZIR TEST HESAPLARI:</b> Veritabanı sıfırlandı; <b>10 işletme</b> + 2 kullanıcı kuruldu, <b>10/10&#39;undan randevu alınabiliyor</b>. Ayrıca hazır bir <b>düğün talebi + 3 teklif</b> ve <b>dolu bir diyet günü</b> var — hesap listesi sana ayrıca verildi.<br><br><b>5 · UYGULAMA HIZLANDI:</b> Fotoğraflar artık ekrandaki boyutta çözülüyor (önceden 1600px&#39;lik bir görsel 120px&#39;lik kutu için tam boyutta açılıyordu) ve açılışta aynı anda atılan istek sayısı sınırlandı. Kaydırmadaki takılma buradan geliyordu.<br><br><b>6 · İŞ İLANI BAŞVURUSU ONARILDI:</b> Geri çektiğin bir başvuruya <b>yeniden başvurabiliyorsun</b> (önceden o işe kalıcı kilitleniyordun).<br><br><b>Sınırlar:</b> Teklif isteğin <b>7 gün</b> açık kalır ve en fazla <b>5 teklif</b> alır. Talepler <b>herkese açıktır</b> — telefon/adres yazma. Otel odaları hâlâ <b>vitrin</b>. Ödeme yok.</div>`;
...
const kontroller = [
  ...
  [cikti.includes('TEKLİF İSTEĞİ') && cikti.includes('DİYET TAKİBİ'),
    'turu 91 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
