...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — AÇILIŞ EKRANI + GİRİŞ/KAYIT YENİLENDİ</b><br><br><b>1 · AÇILIŞ EKRANI GELDİ.</b> Uygulamayı açtığında Instagram/WhatsApp gibi siyah bir ekran karşılıyor: ortada logo, altta <b>Akse Digital</b>. Arkada yüklemeler yapılırken görünüyor, hazır olunca yumuşakça kayboluyor.<br><br><b>2 · GİRİŞ EKRANI YENİLENDİ:</b> kutular gitti — artık sadece <b>2px alt çizgi</b>. &quot;Telefon numarası&quot; yazısı üstte, numara altta. Yazarken çizgi mor oluyor. <b>Şifre yanlışsa alanlar kırmızıya dönüyor</b>, düzeltmeye başlayınca temizleniyor. Düğmelerin köşe yuvarlaklığı kaldırıldı.<br><br><b>3 · KAYIT ARTIK 4 ADIM — PROFİL FOTOĞRAFI EKLENDİ.</b> Son adımda fotoğrafını seçip <b>daire içinde sürükleyerek ve yakınlaştırarak</b> istediğin gibi ayarlıyorsun; ekranda gördüğün kare aynen kaydediliyor. İstemezsen boş geçebilirsin.<br><br><b>4 · ONBOARDING ANİMASYONLU.</b> Üstte kartlar aşağıdan yukarı akıyor (<b>Yakınımda</b> · Yemek · Kafe · Kuaför · Eczane…), bir sayfada da şık bir telefon içinde <b>GebzemAI&#39;ya soru sorulup cevaplanıyor</b>.<br><br><b>5 · LOGO HALKASI DÜZELDİ.</b> Alt menüdeki logonun çevresi turuncuydu; artık <b>hikâye ekleme dairesiyle aynı</b> siyah-mor gradient.<br><br><b>Dürüst sınırlar:</b> <b>Ana ekrandaki uygulama ikonu hâlâ eski</b> — o ayrı bir dosya; istersen onu da yeni logodan üretirim. Menüdeki kutular hâlâ boş (kart görselleri yok). Yakınımda için göndereceğini söylediğin tasarımı bekliyorum. Ana sayfadaki gönderiler ve bildirimler <b>tasarım demosudur</b>.<br><br><b>Not:</b> Sunucu değişmedi; <b>hesaplar ve profiller duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('AÇILIŞ EKRANI GELDİ') &&
      cikti.includes('PROFİL FOTOĞRAFI EKLENDİ'),
    'turu 119 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
