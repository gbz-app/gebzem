...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — ANA SAYFA AKIŞI ve HİKÂYE ŞERİDİ:</b><br><br><b>1 · TASARIM DEMOSU AÇIK:</b> Ana sayfada <b>örnek içerikler</b> var (yazı · fotoğraf · galeri · video · ses · konum · anket). Görseller <b>gri kutu</b> çizilir — sahte fotoğraf koymuyoruz, <b>yerleşimi</b> göresin diye. Bunlara dokununca <b>&quot;Bu bir tasarım demosu&quot;</b> yazar; beğeni/yorum <b>sunucuya gitmez</b>.<br><br><b>2 · HİKÂYE ŞERİDİ:</b> <b>Canlı yayın kırmızı</b>, <b>sesli oda mor</b>. Bu ikisi artık <b>kapsül</b> içinde <b>iki kişi</b> gösteriyor (üst üste binmiyor, aralarında az boşluk) ve sağ üstte <b>izleyici sayısı</b> var. Altında <b>ikonlu CANLI / ODA</b> rozeti. Fotoğrafı olmayan herkes <b>düz gri daire</b> — <b>harf yok</b>.<br><br><b>3 · GÖNDERİ KARTI:</b> Açıklama artık <b>kullanıcı adının altında</b> hizalı. Sol/sağ boşluklar <b>kategori ekranıyla aynı</b>. Kullanıcı adı <b>bir tık büyük</b>. <b>Üç nokta</b> kartın <b>sağ kenarına</b> hizalandı. Paylaş artık <b>sayı</b> gösteriyor ve yanına <b>yeniden paylaş</b> ikonu eklendi. Videoların altındaki <b>mor ilerleme çubuğu kalktı</b> — akışta yalnızca <b>ses aç/kapa</b> var.<br><br><b>4 · DÜZELTİLEN İKİ HATA (ölçüldü):</b> Dar telefonlarda (360dp) etkileşim satırı <b>taşıyor</b> ve <b>kaydet ikonu ekran dışında</b> kalıyordu — artık her genişlikte sığıyor. Alt menüdeki <b>logonun üst kenarına</b> basınca dokunuş <b>alttaki gönderiye</b> geçip yanlış sayfa açıyordu — kapatıldı.<br><br><b>Dürüst sınırlar:</b> Şeritteki <b>canlı/oda</b> ve <b>izleyici sayısı</b> şimdilik <b>demo verisi</b>; sunucu bu bilgiyi henüz döndürmüyor. <b>Yeniden paylaş</b> ikonu şimdilik <b>paylaşma sayfasını</b> açar (repost altyapısı yok). Paylaşım/repost sayıları <b>gerçek akışta 0</b> gelir, uydurma sayı gösterilmez.<br><br><b>Not:</b> Sunucu değişmedi ama <b>gönderi · hikâye · sohbet · bildirim</b> kayıtları <b>senin isteğinle silindi</b>; <b>hesaplar ve profiller duruyor</b>, yeniden kayıt olman gerekmiyor.</div>`
...
const kontroller = [
  ...
  [cikti.includes('ANA SAYFA AKIŞI ve HİKÂYE ŞERİDİ') &&
      cikti.includes('kullanıcı adının altında'),
    'turu 98d icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
