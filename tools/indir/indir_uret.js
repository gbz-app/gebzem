...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — LOGO HALKASI + GEBZEMAI</b><br><br><b>1 · LOGO HALKASI ARTIK STORY GRADIENTİ.</b> Alt menüdeki logonun çevresi hikâye halkasıyla <b>birebir aynı</b> renklere döndü (mor → kırmızı → turuncu). Önceden ikisi farklıydı, yani aynı ekranda iki ayrı &quot;marka gradienti&quot; vardı.<br><br><b>2 · LOGODAKİ &quot;SAYDAM ÇİZGİ&quot;: ARADIM, YOK.</b> Üç yöntemle ölçtüm — kaynak dosyanın saydamlık değerleri, cihazda 8 kat büyütme ve piksel taraması. Logonun üzerinde açıklanamayan tek bir geçiş bile yok. Muhtemel sebep <b>eski halkaydı</b>: sol üstte turuncuyla başlıyordu ve mor logonun kenarında çizgi gibi okunuyordu. Yeni halka morla başlıyor, geçiş yumuşak.<br><br><b>3 · GEBZEMAI EKRANI YENİDEN KURULDU:</b><br>· Geri tuşu artık <b>gönder okunun sola çevrilmişi</b><br>· <b>GebzemAI</b> başlığı ortada, bir tık kalın, 2px küçük<br>· Görsel ve gönder ikonları artık <b>yazı kutusunun içinde</b> — yazı üstte, ikonlar altta, tek parça kutu<br>· Yazarken kutunun kenarlığı <b>marka rengine dönüyor</b><br>· Karşılama ekranı: gradient rozet, her önerinin <b>kendi ikonu</b><br>· <b>Kalan hak artık bir kart</b>: büyük sayı, ilerleme çubuğu, &quot;Her gün sıfırlanır.&quot; Hak bitince kırmızıya dönüyor. Önceden soluk gri bir satırdı — ekrandaki en önemli sayı en silik öğeydi.<br><br><b>Dürüst sınırlar:</b> <b>Ana ekrandaki uygulama ikonu hâlâ değişmedi</b> — o ayrı bir dosya; istersen onu da bu logodan üretirim. GebzemAI&#39;da akan yazı yok ve <b>sohbet kaydedilmiyor</b> (ekrandan çıkınca gider) — bu ekranda da yazılı. Menüdeki kutular hâlâ boş (kart görselleri yok). Yakınımda için göndereceğini söylediğin tasarımı bekliyorum. Ana sayfadaki gönderiler ve bildirimler <b>tasarım demosudur</b>.<br><br><b>Not:</b> Sunucu değişmedi; <b>hesaplar ve profiller duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('LOGO HALKASI ARTIK STORY GRADIENTİ') &&
      cikti.includes('GEBZEMAI EKRANI YENİDEN KURULDU'),
    'turu 117 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
