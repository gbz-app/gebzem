...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — YANIT (THREAD) MİMARİSİ ve REELS:</b><br><br><b>1 · YANIT AĞACI:</b> Yorumlarda soldaki <b>bağlantı çizgisi</b> geldi. Çizgi <b>sadece yanıtı olan</b> yorumda çizilir; alt ucu <b>kıvrılıp</b> küçük bir profil resmine değer, yanında <b>Yanıtları göster</b> yazar. Yanıtlar açılınca o satır <b>kalkar</b> ve çizgi düz iner — çünkü kıvrım &quot;burada gizli içerik var&quot; demektir, açıkken gizli içerik kalmaz.<br><br><b>2 · AKIŞTA YANIT:</b> Bazı gönderilerin altında <b>bir yanıt</b> görünüyor ve gönderiye <b>düz dikey çizgiyle</b> bağlı (kıvrım yok — devam ekranda). Yanıtlar artık <b>görsel/video</b> da taşıyabiliyor.<br><br><b>3 · GÖNDERİ DETAYI:</b> <b>Yazışma</b> ekranı: görüntülenme, <b>konu etiketi</b>, <b>Başlıca ⌄</b> sıralama menüsü, <b>Hareketi gör ›</b> ve altta sabit <b>yanıt kutusu</b>. Yorumlarda <b>mavi tik</b>, <b>Gönderi Sahibi</b> rozeti ve <b>yazarın beğenisi</b> (kırmızı kalp + minik avatar) görünüyor.<br><br><b>4 · GÖNDERİ HAREKETLERİ:</b> &quot;Hareketi gör&quot; yeni bir ekran açıyor — kim beğendi/yanıtladı, avatarın köşesinde <b>eylem rozeti</b>, sağda <b>Takip Et</b>, üstte <b>Sırala</b>.<br><br><b>5 · REELS ARTIK X (TWITTER) DÜZENİNDE:</b> Sağdaki dikey ikon kolonu kalktı; altta solda profil, <b>2 satıra kısaltılmış açıklama</b> (dokununca açılıyor), zaman ve <b>hap şeklinde</b> eylem satırı. <b>Yoruma basınca alttan thread paneli</b> açılıyor.<br><br><b>6 · ÜÇ NOKTA MENÜSÜ:</b> Gruplu kartlar; sponsorlu gönderide ayrı <b>reklam menüsü</b>.<br><br><b>Dürüst sınırlar:</b> <b>Yorum beğenisi sunucuda yok</b> (tablo var, uç yok) — ekranda artar ama kaydedilmez. <b>Konu etiketi</b>, <b>alıntı/yeniden paylaş</b>, <b>ortak takipçi</b> ve <b>bildirim zili</b> için de altyapı yok; bunlar <b>tasarım demosu</b> olarak çiziliyor ve gerçek akışta sahte sayı çıkmıyor. Ana sayfadaki gönderiler de <b>örnek içeriktir</b>.<br><br><b>Not:</b> Sunucu değişmedi; <b>hesaplar ve profiller duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('YANIT (THREAD) MİMARİSİ ve REELS') &&
      cikti.includes('Yanıtları göster'),
    'turu 101 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
