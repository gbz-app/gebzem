...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — GİRİŞ VE KAYIT TEK AKIŞ OLDU</b><br><br><b>1 · ARTIK &quot;GİRİŞ Mİ KAYIT MI&quot; SEÇMİYORSUN.</b> Numaranı yazıp &quot;Giriş yap&quot;a basıyorsun; numara kayıtlıysa şifre soruluyor, kayıtlı değilse kod gönderilip doğrudan kayda geçiliyor. &quot;Hesabın yok mu? Kayıt ol&quot; bağlantısı bu yüzden kalktı.<br><br><b>2 · GİRİŞ EKRANI.</b> Sol üstte geri oku, <b>Seni görmek ne güzel</b> / <b>Hadi başlayalım</b>, altında tek satır telefon: <code>+90 512 345 67 89</code>. Numara yazarken kendiliğinden gruplanıyor, yazdıkça hem numara hem <code>+90</code> koyulaşıyor, alt çizgi siyaha dönüyor. Düğmenin üstünde kısa bir not var.<br><br><b>3 · KAYIT DOKUZ ADIM.</b> Numara · şifre · kod · ad · kullanıcı adı · yaş · cinsiyet · ilgi alanları · fotoğraf. Her adımda üstte ince bir satır, altında kalın başlık. <b>Step çizgileri kaldırıldı.</b><br><br><b>4 · KOD EKRANI.</b> Altı hane <code>3 ─ 3</code> biçiminde, her hanenin altında çizgi.<br><br><b>5 · KULLANICI ADI AYRI SAYFADA</b> ve sağında yeşil daire içinde tik ya da kırmızı çarpı. <b>Dikkat:</b> bu işaret &quot;bu ad müsait&quot; demiyor, <b>&quot;biçim doğru&quot;</b> diyor — sunucuda müsaitlik soran bir uç yok, çakışma ancak kayıt tamamlanırken çıkıyor.<br><br><b>6 · YAŞ 20&#39;de açılıyor</b>, seçim bandının mor zemini ve yuvarlak köşesi kaldırıldı. Cinsiyette iki seçenek var, boş bırakılabiliyor. <b>Tuttuğun takım</b> kayıttan çıkarıldı.<br><br><b>7 · KLAVYE ARTIK SAYFAYI OYNATMIYOR.</b> Her dokunuşta bütün sayfa zıplıyordu; sebep Flutter&#39;ın varsayılan davranışıydı (klavye açılırken gövdenin tamamı kısalıyor). Kapatıldı — üst içerik kıpırdamıyor, yalnızca düğme klavyeyle birlikte yumuşak çıkıyor.<br><br><b>Yakalanan iki hata:</b> (a) Giriş ekranından kayda geçince <b>şifre adımı tamamen atlanıyordu</b>, yani o kayıt son adımda sunucudan hata alırdı. (b) &quot;Adın ne?&quot; adımında <b>&quot;Devam&quot; hiçbir şey yapmıyordu</b> — adım sayısı artınca geçiş kendi adımına gidiyordu.<br><br><b>Dürüst sınırlar:</b> <b>Cinsiyet sunucuya gönderilmiyor</b> (veritabanında sütunu yok, ekranda tutuluyor). <b>&quot;Şifremi unuttum&quot; ve &quot;Kod gelmedi mi?&quot; ekranda yok</b> — gerçek SMS&#39;e geçilince ikisi de gerekecek.<br><br><b>Not:</b> <b>Yalnızca arayüz</b>, <b>yalnızca iPhone</b>. Sunucu değişmedi, hesaplar duruyor.</div>`;
...
const kontroller = [
  ...
  [cikti.includes('GİRİŞ VE KAYIT TEK AKIŞ OLDU') &&
      cikti.includes('KULLANICI ADI AYRI SAYFADA'),
    'turu 126b icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
