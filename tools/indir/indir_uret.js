...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — ÜÇ NOKTA MENÜSÜ, CANLI/ODA ve GÖNDERİ DETAYI:</b><br><br><b>1 · ÜÇ NOKTA MENÜSÜ YENİ:</b> Gönderideki <b>•••</b> artık gruplu kartlar halinde açılıyor: <b>Bağlantıyı kopyala</b> · <b>Kaydet</b> · <b>İlgilenmiyorum</b> · <b>Sessize al</b> · <b>Kısıtla</b> · <b>Engelle</b> · <b>Şikayet Et</b> (son ikisi kırmızı). Kendi gönderinde en üstte <b>Düzenle · İstatistik · Sil</b>. <b>Sponsorlu</b> gönderide ayrı bir <b>reklam menüsü</b> çıkıyor (İlgimi Çekiyor / Çekmiyor, Reklamı gizle, Reklamı şikayet et, Bu reklamı neden görüyorum?).<br><br><b>2 · CANLI ve ODA TEK PROFİL:</b> Yayını/odayı <b>kim açtıysa onun resmi</b> görünüyor; ikinci profil kaldırıldı. Halka <b>canlıda kırmızı</b>, <b>odada mor</b>; <b>izleyici sayısı</b> dairenin tam üstünde, altında ikonlu <b>CANLI / ODA</b> rozeti.<br><br><b>3 · GÖNDERİ DETAYI:</b> Yorum ikonuna dokununca <b>Yazışma</b> ekranı açılıyor — görüntülenme sayısı, <b>Başlıca / Hareketi gör</b> satırı ve <b>bağlantı çizgili yorumlar</b> (mavi tik, yazarın beğenisi, <b>Gönderi sahibi</b> rozeti, <b>Yanıtları göster</b>).<br><br><b>4 · AKIŞ:</b> Bazı gönderilerin altında <b>bir yanıt</b> görünüyor. Beğenince kalp <b>tamamen kırmızı</b> doluyor, sayı da kırmızı olup <b>yukarı kayarak</b> değişiyor. Yeniden paylaş ikonu <b>redo</b>. Üst çubukta <b>Arkadaşlar · Keşfet · Canlı Yayın</b> ortada.<br><br><b>5 · HİKÂYE ŞERİDİ:</b> Daireler <b>65 dp</b> ve <b>hepsi eşit</b> (ekleme dairesi dahil), aralarındaki boşluk <b>9 dp</b>, şerit ile ilk gönderi arası <b>20 dp</b>.<br><br><b>Dürüst sınırlar:</b> Menüdeki <b>İlgilenmiyorum · Sessize al · Kısıtla</b> ve <b>reklam menüsünün tamamı</b> sunucuda <b>yok</b> — dokununca sessizce bir şey yapmış gibi davranmıyor, durumu söylüyor. <b>Bağlantıyı kopyala · Kaydet · Engelle · Şikayet Et · Düzenle · İstatistik · Sil</b> gerçekten çalışır. Ana sayfa hâlâ <b>tasarım demosu</b>: gönderiler, yorumlar ve izleyici sayıları örnek veridir, sunucuya hiçbir şey gitmez.<br><br><b>Not:</b> Sunucu değişmedi; <b>hesaplar ve profiller duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('ÜÇ NOKTA MENÜSÜ, CANLI/ODA ve GÖNDERİ DETAYI') &&
      cikti.includes('reklam menüsü'),
    'turu 98l icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
