...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — KATEGORİ EKRANI BAŞTAN DÜZENLENDİ:</b><br><br><b>1 · KEŞİF KARTLARI:</b> Üstteki kayan alanın altında <b>8 kart</b> — <b>Ne Yesem?</b> (rastgele bir işletme açar), <b>İndirimli</b>, <b>Yüksek Puanlı</b>, <b>En Hızlı</b>, <b>Yakınımda</b>, <b>Şu An Açık</b>, <b>Uygun Fiyatlı</b>, <b>Favorilerim</b>. Sekizi de gerçekten süzüyor/sıralıyor.<br><br><b>2 · FİLTRE EKRANI:</b> Arama kutusundaki süzgeç ikonuna dokun — <b>tam ekran</b> açılır: Sıralama, Minimum sepet tutarı, Puan, Teslimat süresi, Kampanyalı ve Şu an açık. Altta <b>İşletmeleri listele</b>.<br><br><b>3 · MUTFAKLAR:</b> Arama kutusunun altında <b>Mutfaklar</b> başlığı ve Döner/Kebap/Pide kartları — <b>her kategori kendine özel</b> (Kuaför&#39;de Saç Kesim/Boya...).<br><br><b>4 · KART MESAFESİ:</b> İşletme kartında <b>puan · süre · minimum tutar</b>&#39;ın yanına <b>uzaklık</b> eklendi (<b>1,2 km</b> / <b>300 m</b>). Ekran açılırken <b>konum izni</b> istenir; vermezsen liste normal çalışır, yalnızca uzaklık yazılmaz.<br><br><b>5 · GÖRÜNÜM:</b> Liste başlığında solda <b>İşletmeler (N)</b>, sağda <b>liste/kart</b> ve <b>harita</b> düğmeleri.<br><br><b>6 · TASARIM:</b> Yeşil vurgular kaldırıldı — seçili her şey artık <b>siyah kenarlık</b>. Köşe yuvarlaklığı tek kurala bağlandı; tüm ölçüler ve boşluklar <b>ekrandan ölçülerek</b> hizalandı. Kayan alanda <b>yandaki slaytlar</b> hafifçe görünüyor.<br><br><b>7 · HAZIR TEST HESAPLARI:</b> Veritabanı sıfırlandı; <b>14 işletme</b> (2 restoran + 2 kafe + doktor, diyetisyen, kuaför, güzellik, otel) + 2 kullanıcı, <b>14/14&#39;ünden randevu alınabiliyor</b>, hazır bir <b>düğün talebi + 3 teklif</b> ve <b>dolu bir diyet günü</b> var — hesap listesi ayrıca verildi.<br><br><b>Sınırlar:</b> Karttaki <b>puan, teslimat süresi ve minimum tutar</b> işletmenin girdiği değerlerdir; <b>değerlendirme sistemi ve sipariş/kurye modeli henüz yok</b>. Filtre ekranında <b>ödeme yöntemi</b> bölümü yok — o veri henüz hiç tutulmuyor, boş bir seçenek koymadık. Süzme şimdilik <b>uygulama içinde</b> yapılıyor (listenin ilk 60 kaydı üzerinde). Kayan alan hâlâ <b>boş</b> — görsel/kampanya için hazır bekliyor. Teklif isteğin <b>7 gün</b> açık kalır, en fazla <b>5 teklif</b> alır. Talepler <b>herkese açıktır</b> — telefon/adres yazma. Ödeme yok.</div>`;
...
const kontroller = [
  ...
  [cikti.includes('KEŞİF KARTLARI') && cikti.includes('Ne Yesem?'),
    'turu 96 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
