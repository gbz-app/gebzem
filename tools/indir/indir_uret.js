...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — YAKINIMDA YENİLENDİ, HİZMET VERENLER GELDİ, PROFİL KAPAĞI BÜYÜDÜ</b><br><br><b>1 · YAKINIMDA.</b> Arama artık kartın en üstünde. Filtreler <b>kartın üzerinde yüzüyor</b> — içinde değil, 10px yukarısında. Her çipe <b>ikon</b> eklendi (çatal, kahve, araba, hap, makas; ayak izi, bisiklet, yıldız, etiket). Alttaki fazla boşluk kısaldı.<br><br><b>2 · ÇİPLERDEKİ &quot;PATLAMA&quot; GİTTİ.</b> Sebebi Material&#39;in hazır çipiydi: seçilince soluna bir tik koyup çipi ~24px genişletiyor, sağındaki bütün çipleri kaydırıyordu. Artık çip <b>sabit ölçülü</b>; seçilince yalnızca rengi değişiyor.<br><br><b>3 · İLAN KARTINDA FAVORİ KALBİ.</b> Yemek kartındaki kalbin aynısı, kapağın sağ üstünde. Önceden favorilemek için ilana girmek gerekiyordu.<br><br><b>4 · HİZMETTE &quot;HİZMET VERENLER&quot;.</b> Ekran yalnızca talep oluşturmaya yarıyordu; &quot;kimler bu işi yapıyor&quot; sorusunun cevabı yoktu. Artık altında gerçek işletme kartları var — Yemekteki kartın aynısı.<br><br><b>5 · PROFİL.</b> Sekmeler (Gönderiler, İlanlar…) artık <b>tam genişlikte bir çizginin üzerinde</b> — Instagram/Twitter gibi. Arka <b>kapak yüksekliği artırıldı</b>: 153px → 202px.<br><br><b>Ölçülen hata:</b> &quot;Hizmet verenler&quot; ilk yazımda <b>her zaman boş</b> geliyordu. Sebep: <code>hizmet</code> kategorisinde veritabanında <b>tek işletme yok</b> (otel 11, kuaför 8, diyetisyen 8, eczane 6…) — &quot;hizmet&quot; bir talep dalı, işletmeler kendi mesleklerine kayıtlı. Artık hizmet sektörü kategorilerinden çekiliyor.<br><br><b>Dürüst sınırlar:</b> Hızlı erişim kartlarının içeriği (&quot;Gece Kuşu&quot;, &quot;Yeni Restourant&quot;, &quot;Teslimat&quot;) hâlâ yemeğe özel ve diğer kategorilerde anlamsız — <b>sıradaki iş bu</b>. Google&#39;ın mavi konum noktası platformca çizildiği için kapatılıp kendi mor işaretimiz kondu.<br><br><b>Not:</b> <b>Yalnızca arayüz</b>, <b>yalnızca iPhone</b>. Sunucu değişmedi, hesaplar duruyor.</div>`
...
const kontroller = [
  ...
  [cikti.includes('YAKINIMDA YENİLENDİ') &&
      cikti.includes('HİZMET VERENLER'),
    'turu 125 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
