...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — arayüz turu</b><br><br><b>1 · ARTIK HER YER MOR (yeşil bitti).</b> Marka rengi logonun moruna çekildi: seçili sekmeler, düğmeler, <b>mesaj balonları</b>, ses notu dalga formu, puan yıldızı, sohbetteki arama ikonları. Alttan açılan paneller ve uyarılar artık sayfayla <b>aynı zeminde</b> (pembemsi açılıyorlardı).<br><br><b>2 · &quot;+&quot; PENCERESİ YENİDEN TASARLANDI:</b> üstte üç büyük kart (<b>Gönderi · Reels · Canlı</b>), altta Hikâye · Sesli oda · Grup.<br><br><b>3 · SOHBET MODERNLEŞTİ:</b> ataç artık yazı kutusunun <b>içinde</b>, gönder tuşu dolu daire; başlıkta avatar büyüdü; sohbet listesi satırları ferahladı; <b>Sohbetler/Aramalar</b> seçicisi kayan hap oldu.<br><br><b>4 · AÇIK TEMADA GÖRÜNMEYEN İKİ YER DÜZELDİ:</b> sohbet arama kutusu <b>simsiyah</b> çıkıyordu; &quot;Sık görüştüklerin&quot; isimleri <b>neredeyse görünmüyordu</b> (beyaz üstüne beyaz).<br><br><b>5 · ARAMADA SEKMELER:</b> <b>Kişiler · Yerler · İşletmeler · İlanlar · Ses</b> — yazmadan da görünüyor. Altında <b>Trendler</b>; sıralamayı belirleyen görüntülenme sayısı da yazıyor.<br><br><b>6 · PROFİLDE YATAY SEKME ŞERİDİ</b> (Instagram/Twitter gibi) — açılır menü kalktı, sekmeler ekranda duruyor ve sola-sağa kayıyor.<br><br><b>7 · HARİTA PİNLERİ DAİRE</b> oldu, açık renk halkalı.<br><br><b>Ölçülüp düzeltilen taşmalar:</b> mesajlar &quot;+&quot; penceresi büyük yazıda son maddeyi ekran dışına atıyordu · sohbet listesinin sağ sütunu taşıyordu · trend sıra numarası alt alta sarıyordu · &quot;Gönderi&quot; etiketi kırpılıyordu. Hepsi <b>360 dp + büyük yazı</b> ile ölçüldü.<br><br><b>Dürüst sınırlar:</b> Ana sayfadaki gönderiler, bildirimler ve örnek ilanlar <b>tasarım demosudur</b>. Menüdeki kutular boş — kart görselleri henüz yok. Yakınımda ekranı için yeni tasarım bekleniyor, bu sürümde dokunulmadı. <b>Akaryakıt fiyatı</b> projede hiçbir yerde yok, o yüzden fiyat filtresi <b>koymadım</b>.<br><br><b>Not:</b> Sunucu değişmedi; <b>hesaplar ve profiller duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('ARTIK HER YER MOR') &&
      cikti.includes('PROFİLDE YATAY SEKME ŞERİDİ'),
    'turu 115c icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
