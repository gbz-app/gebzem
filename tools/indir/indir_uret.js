...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — HİZMET EKRANI DA AYNI DÜZENDE + HER KATEGORİYE KENDİ SIRALAMASI</b><br><br><b>1 · HİZMET / DÜĞÜN EKRANI ARTIK DİĞERLERİYLE AYNI.</b> Kategori kartlarına dokunup <b>adım adım</b> ilerlemek zaten vardı; eksik olan ekranın geri kalanıydı — ne filtre çipi ne liste vardı, taleplerine ancak sağ üstteki ikondan ulaşabiliyordun. Şimdi kartların altında <b>Tümü · Açık · Anlaşıldı</b> çipleri ve <b>&quot;Taleplerim (N)&quot;</b> listesi var; aşağı çekince tazeleniyor. Yani Yemek, İlan ve Hizmet aynı iskelette: kartlar → çipler → liste.<br><br><b>2 · İLANA SIRALAMA GELDİ.</b> Yemekteki &quot;Sıralama&quot; çipinin ilana göre karşılığı: <b>Yeniden eskiye · Ucuzdan pahalıya · Pahalıdan ucuza</b>. Çip, seçtiğin sıralamanın adını yazıyor.<br><br><b>3 · ALT KATEGORİ BAŞLIĞI ARTIK KATEGORİYE GÖRE.</b> Başlık 17 kategoride de sabit &quot;Mutfaklar&quot; yazıyordu — Eğitim ekranında &quot;Dershane · Kurs · Dil&quot; şeridinin üstünde bile. Artık Alanlar / Bölümler / Hizmetler / Reyonlar.<br><br><b>Bu turda yakalanan hatalar:</b> Yayından önce koşturduğum denetim <b>37 gerçek hata</b> buldu. En ağırı: fiyat ve şehir filtresi <b>örnek ilanlara hiç uygulanmıyordu</b> — &quot;1.000 TL altı&quot; seçtiğinde 985.000 TL&#39;lik örnek daire listede kalıyordu; düzeltildikten sonra ölçüldü, <b>22 ilan → 3</b>. İlandaki kategori kutuları mor 2px, hemen altındaki çipler siyah 1.6px kenarlıklıydı (Yemek ile birebir hizalandı). Etkinliklerde &quot;Geçmiş&quot; bir sekme olduğu hâlde filtre sayılıyordu. Çipler 32 yerine 40px çiziliyordu. Fiyat panelinin düğmeleri jest çubuğunun altında kalıyordu. İlanda liste boşalınca &quot;Henüz favori ilanın yok&quot; yalanı çıkıyordu.<br><br><b>Dürüst sınırlar:</b> İlanda sıralama telefonda yapılıyor (sunucuda sıralama parametresi yok) — liste tek seferde geldiği için sonuç doğru; <b>fiyatı belirtilmemiş ilanlar daima sona</b> gider. Hizmetteki durum çipleri sunucunun kendi durum değerlerinden, uydurma yok. İlanda slider yok: sunucu ilan slaytı üretmiyor, koysaydım alakasız emlakçı kartları çıkardı. Hızlı erişim kartları (&quot;Gece Kuşu&quot;, &quot;Yeni Restourant&quot;, &quot;Teslimat&quot;) hâlâ yemeğe özel ve diğer kategorilerde anlamsız — <b>sıradaki iş bu</b>.<br><br><b>Not:</b> Bu tur <b>yalnızca arayüz</b> ve <b>yalnızca iPhone</b>. Sunucu değişmedi, <b>hesaplar ve tüm veriler duruyor</b>.</div>`
...
const kontroller = [
  ...
  [cikti.includes('HİZMET EKRANI DA AYNI DÜZENDE') &&
      cikti.includes('İLANA SIRALAMA GELDİ'),
    'turu 122 icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
