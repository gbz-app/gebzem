...
const YENI_ICERIK = `<div class="yeni"><b>Bu sürümde — ALT MENÜ YENİDEN TASARLANDI:</b><br><br><b>1 · ALT MENÜ ARTIK SİYAH ve YAZISIZ:</b> İkonların altındaki <b>Anasayfa · Ara · Reels</b> gibi yazılar kaldırıldı, ikonlar <b>biraz yukarı</b> alındı. Seçili sekme <b>beyaz</b>, diğerleri <b>açık gri</b> çiziliyor. (Yazılar ekrandan kalktı ama <b>ekran okuyucu</b> için duruyor.)<br><br><b>2 · ORTADAKİ LOGO:</b> Daire içine alındı, biraz büyütüldü ve diğer ikonlardan <b>10 piksel yukarıda</b> duruyor. <b>Dokununca menü açılıyor</b> — sol üstteki hamburger düğmesiyle aynı menü.<br><br><b>3 · EN SAĞDAKİ PROFİL:</b> Artık ikon değil <b>profil resmin</b>. Resim yoksa <b>aynı boyutta gri bir daire</b> çiziliyor (eskiden adının <b>baş harfi</b> yazıyordu). <b>Canlı yayın</b> ikonu da diğerleriyle aynı görünsün diye büyütüldü.<br><br><b>4 · ALT MENÜ KATEGORİ EKRANINDA DA VAR:</b> Yemek gibi bir kategoriye girince alt menü kayboluyordu, uygulamanın geri kalanına geçemiyordun. Artık orada da duruyor.<br><br><b>5 · LİSTE EKRANI İNCE AYAR:</b> Boşluklar <b>kademeli</b> hale getirildi (başlık kendi kartlarına <b>yakın</b>, bölümler arası <b>uzak</b>); keşif kartlarının hepsi artık <b>aynı yükseklikte</b> (bazıları iki satıra sardığı için ızgara altındaki boşluk kaymıyor); <b>görünüm seçici</b> (liste · kart · harita) filtre çipiyle aynı ölçüye getirildi; kart altındaki <b>25-35 dk</b> gibi yazılar filtre yazılarıyla aynı kalınlıkta; <b>kalpler</b> büyütüldü.<br><br><b>Önceki sürümün tamamı duruyor:</b> konum seçme (<b>GPS</b> ya da <b>haritadan pin taşıyarak</b>) · kartlarda <b>uzaklık</b> · 8 keşif kartı · <b>Filtre</b> paneli (süzme sunucuda) · <b>Mutfaklar</b> şeridi · <b>liste · kart · harita</b> geçişi · randevu · teklif · diyet.<br><br><b>Not:</b> Bu sürümde <b>sunucu tarafı değişmedi</b>; hesaplar ve veriler <b>olduğu gibi duruyor</b>, yeniden kayıt olman gerekmiyor.<br><br><b>Sınırlar:</b> Karttaki <b>puan, teslimat süresi ve minimum tutar</b> işletmenin girdiği değerlerdir; <b>değerlendirme sistemi ve sipariş/kurye modeli henüz yok</b>. Kategori ekranında <b>geri düğmesi yok</b> — telefonun geri tuşuyla çıkılır. Talepler <b>herkese açıktır</b> — telefon/adres yazma. Ödeme yok.</div>`
...
const kontroller = [
  ...
  [cikti.includes('ALT MENÜ YENİDEN TASARLANDI') && cikti.includes('Dokununca menü açılıyor'),
    'turu 96n icerigi yazilmadi (YENI_ICERIK guncellenmemis)'],
