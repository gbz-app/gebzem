...
- **ARAMA TESTİ (3. deneme):** iki cihaza kur → izin ver → kayıt ol → @kullanıcıadı ile bul → sohbette 📞/📹 → kabul → ses gelmeli
- Sonraki: CallKit (kilit ekranında çalma) → grup araması → Faz 2 (gruplar/story/profil/medya) → uygulama ikonu
